...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>LAOV Kim Heng Thay | Full-Stack Developer</title>
        <meta name="description" content="Full-stack developer specializing in React and Laravel. Based in Cambodia, building high-performance web applications and scalable APIs." />
